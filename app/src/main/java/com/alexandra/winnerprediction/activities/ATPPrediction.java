...
public class ATPPrediction extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.atp_prediction);
        ...
        bottomNavigationView.getMenu().findItem(R.id.atp).setChecked(true);
//        bottomNavigationView.getMenu().findItem(R.id.atp).setIcon(getResources().getDrawable(getResourceID("ic_svg_ball_blue", "drawable", getBaseContext())));
//        bottomNavigationView.getMenu().findItem(R.id.wta).setIcon(getResources().getDrawable(getResourceID("ic_svg_ball_grey", "drawable", getBaseContext())));
        ...
        ArrayAdapter<CharSequence> draw_size_adapter = ArrayAdapter.createFromResource(this,
                R.array.draw_size_atp, R.layout.spinner_item);
    ...
    private List<String> get_tournaments(){
        ...
        try {
            InputStream is = getAssets().open("tourneys_atp.json");
    ...
    private class CallPython extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void params) {
            ...
            Intent intent = new Intent(ATPPrediction.this, ATPResult.class);
